...
## Plugins
 ...
 - [vim-jack-in](https://github.com/clojure-vim/vim-jack-in) *Easy jack-in to a deps or lein nREPL directly from nvim*
...
### vim-jack-in - Start nREPL
**`:Clj` or `:Lein`** starts a `deps` or `leiningen` REPL on a separate terminal
